...
func (m *MockGitCommandClient) Clone(ctx context.Context, org, repo string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Clone", ctx, org, repo)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockGitCommandClientMockRecorder) Clone(ctx, org, repo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Clone", reflect.TypeOf((*MockGitCommandClient)(nil).Clone), ctx, org, repo)
}
...
func (m *MockGitCommandClient) Remove(ctx context.Context, dir string) error {
	m.ctrl.T.Helper()
...
func (mr *MockGitCommandClientMockRecorder) Remove(ctx, dir interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Remove", reflect.TypeOf((*MockGitCommandClient)(nil).Remove), ctx, dir)
}
